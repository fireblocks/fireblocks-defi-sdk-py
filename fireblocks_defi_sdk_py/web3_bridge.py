...
from fireblocks_sdk import FireblocksSDK, TransferPeerPath, DestinationTransferPeerPath, ONE_TIME_ADDRESS, \
    VAULT_ACCOUNT, CONTRACT_WALLET, TRANSACTION_STATUS_BLOCKED, TRANSACTION_STATUS_COMPLETED, TRANSACTION_STATUS_FAILED
...
class Web3Bridge:
    ...
    def send_transaction(self, transaction: dict, note="") -> dict:
        ...
        """
        if self.wl_uuid:
            destination = TransferPeerPath(CONTRACT_WALLET, self.wl_uuid)
        else:
