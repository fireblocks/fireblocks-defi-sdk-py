...
VAULT_ID = "0"
CONTRACT = "0x73544d05210be973901ea33034191a61969f9271"
RECEIVER_ADDRESSES = "0x76D6063b0A35Ec0f84fd22bA2F93754Fbf180e59"
...
if __name__ == "__main__":
    ...
    multi_token_contract = ERC1155(kovan_bridge)
    ...
    # another address.
    tokens_balance = multi_token_contract.balance_of_batch(TOKEN_IDS)
    if tokens_balance:
        ...
        transfer_tokens = multi_token_contract.safe_batch_transfer_from(RECEIVER_ADDRESSES, TOKEN_IDS, tokens_balance,
