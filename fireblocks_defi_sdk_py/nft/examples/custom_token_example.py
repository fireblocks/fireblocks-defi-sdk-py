...
if __name__ == "__main__":
    ...
    if custom_contract_bridge.call_read_function("contractOwner", custom_contract_bridge.wallet_address):
        ...
        building_params = {"from": custom_contract_bridge.wallet_address}
        ...
        if ropsten_bridge.check_tx_is_completed(transfer_ownership_transaction['id']) == TRANSACTION_STATUS_COMPLETED:
            ...
            building_params['from'] = secondary_contract_bridge.wallet_address
